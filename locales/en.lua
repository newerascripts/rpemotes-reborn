Locales['en'] = {
    ...
    ['walks_command_help'] = 'List available walking styles.',
    ['walk_command_help'] = 'Set your walkingstyle.',
    ['walk_command_param'] = 'style',
    ['walk_command_param_help'] = '/walks for a list of valid styles',
    ...
    ['resetsettings'] = "Emote menu settings have been reset to default.",
    ['fast_anim'] = "Fast Animation",
    ['emote_positioning_command'] = "Emote Positioning Mode",
    ['emote_data_not_found'] = "Emote data not found.",
    ...
    ['position_canc'] = "Positioning cancelled.",
    ['must_start_emote_first'] = "You must start an emote first.",
